...
request.open('GET', 'https://api.clickup.com/api/v2/list/52908134/task?include_closed=true&subtasks=true');
...
request.onload = function () {
    if (request.status >= 200 && request.status < 400) {
        ...
        if (size >= 100) {
            ...
            request2.open('GET', 'https://api.clickup.com/api/v2/list/52908134/task?include_closed=true&subtasks=true&reverse=true');
